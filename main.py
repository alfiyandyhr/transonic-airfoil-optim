...
#for i in range(50):
#	os.makedirs('Meshes/random_design' + str(i))
...
# airfoil_mesh_random_design1 = AirfoilMesh(
# 	file_in='bspline_points_random1.dat',
# 	file_out='random_design1.su2',
# 	con_dimension=con_dimension,
# 	le_spacing=le_spacing,
...
# 	dim=dimension,
# 	mesh_type=mesh_type)
# airfoil_mesh_random_design1.unstructured(
# 	algorithm,
# 	size_field_decay,
# 	farfield_radius,
# 	farfield_dim)
...
# 		file_in='initial_samples/bspline_points/bspline_points_random' + str(i) + '.dat',
